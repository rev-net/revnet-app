  ...
  return (
    <div className="container">
      ...
      <div className="grid grid-cols-2 gap-5">
        <div className="relative flex items-center space-x-3 rounded-lg border border-zinc-400 bg-white px-6 py-5 shadow-sm focus-within:ring-2 focus-within:ring-indigo-500 focus-within:ring-offset-2 hover:border-zinc-400">
