  ...
  return (
    <div className="container mt-40">
      ...
      <div className="mt-10 max-w-prose text-l md:text-2xl text-left">
        <p className="mb-10">
          A revnet serves as a hands-free, all-in-one tokenized incentive machine, cap table, and growth engine for leaders, workers, artists, investors, and customers of growth-oriented businesses, brands, campaigns, communities, and indie projects.
        </p>
