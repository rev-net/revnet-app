                    ...
                    <div className="max-w-md space-y-2 p-2">
                      <div className="space-y-1">
                        ...
                        <p className="text-md text-black-400">
                          Determines how many {formatTokenSymbol(token)} are
                          created when this revnet receives funds during a
                          stage.
                        </p>
                          ...
                          <span className="italic">
                            ...
                            <ul className="list-disc list-inside pl-4 space-y-2">
                              <li className="flex">
                                ...
                                <div>
                                  If there's a market for{" "}
                                  {formatTokenSymbol(token)} / {tokenA.symbol}{" "}
                                  offering a better price, all {tokenA.symbol}{" "}
                                  paid in will be used to buyback instead of
                                  feeding the revnet. Uniswap is used as the
                                  market.
                                </div>
                              </li>
                            </ul>
                      ...
                      <div className="space-y-1">
                        ...
                        <p className="text-md text-black-400">
                          Determines how much of {formatTokenSymbol(token)}{" "}
                          issuance is set aside to be split among recipients
                          defined by the split operator during a stage.
                        </p>
                        <p className="text-md text-black-400">
                          The operator is the account that can change the split
                          recipients, within the permanent split limit amount of
                          a stage. See the "Owners" table for the current
                          breakdown.
                        </p>
                        <div className="text-zinc-600 text-md mt-4">
                          <span className="italic">
                            ...
                            <ul className="list-disc list-inside pl-4 space-y-2">
                              ...
                              <li className="flex">
                                ...
                                <div>
                                  ...
                                  split {formatTokenSymbol(token)}. See{" "}
                                  <a
                                    className="underline"
                                    target="_blank"
                              ...
                              <li className="flex">
                                <span className="mr-2">•</span>
                                <div>
                                  If there are splits, the operator can change
                                  the distribution of the split limit to new
                              ...
                              <li className="flex">
                                <span className="mr-2">•</span>
                                <div>
                                  The operator can be a multisig, a DAO, an LLC,
                                  a core team, an airdrop stockpile, a staking
                                  rewards contract, or some other address.
                                </div>
                              </li>
                              <li className="flex">
                                <span className="mr-2">•</span>
                                <div>
                                  ...
                                  responsibility to another address at any time,
                              ...
                              <li className="flex">
                                <span className="mr-2">•</span>
                                <div>
                                  A revnet can have different split destinations
                                  on each chain it exists on, but they're all
                                  bound by the same total split limit
                                  percentage.
                                </div>
                              </li>
                            </ul>
                  ...
                  <TooltipContent side="right">
                    <div className="max-w-md space-y-2 p-2">
                      <div className="space-y-1">
                        ...
                        <p className="text-md text-black-400">
                          An amount of {formatTokenSymbol(token)} that is
                          inflated automatically once the stage starts. See the
                          "Owners" table for the breakdown.
                        </p>
                      </div>
                    </div>
                  </TooltipContent>
                    ...
                    <div className="max-w-md space-y-2 p-2">
                      <div className="space-y-1">
                        ...
                        <p className="text-md text-black-400">
                          ...
                          {formatTokenSymbol(token)} revenue is by cashing out
                          or taking out a loan against their{" "}
                          {formatTokenSymbol(token)}, both offered by the revnet
                          out of the box.
                        </p>
                        <p className="text-md text-black-400">
                          A tax can be added that makes the cost of cashing out
                          and borrowing money more expensive.
                        </p>
                        <p className="text-md text-black-400">
                          This can be used to reward {formatTokenSymbol(token)}{" "}
                          holders who stick around while others cash out, with
                          the tradeoff of making loans more expensive.
                        </p>
                        <p className="text-md text-black-400">
                          ...
                          <span className="italic">
                            ...
                            <ul className="list-disc list-inside pl-4 space-y-2">
                              <li className="flex">
                                <span className="mr-2">•</span>
                                <div>
                                  The heavier the tax, the less that can be
                                  accessed by cashing out or taking out a loan
                                  at any given time, and the more that is left
                                  to share between remaining holders who cash
                                  out later.
                                </div>
                              </li>
                              <li className="flex">
                                ...
                                <div>
                                  ...
                                  {formatTokenSymbol(token)}. By making loans
                                  more expensive, a heavier cash out tax reduces
                              ...
                              <li className="flex">
                                <span className="mr-2">•</span>
                                <div>
                                  Given 100 {tokenA.symbol} in the revnet, 100
                                  total supply of {formatTokenSymbol(token)},
                                  and 10 {formatTokenSymbol(token)} being cashed
                                  out, a tax rate of 0 would yield a cash out
                                  value of 10 {tokenA.symbol}, 0.2 would yield
                                  8.2 {tokenA.symbol}, 0.5 would yield 5.5{" "}
                              ...
                              <li className="flex">
                                ...
                                <div>
                                  ...
                                  + xr/s)` where: `r` is the cash out tax rate,
                                  `a` is the amount in the revnet being
                                  accessed, `s` is the current token supply of{" "}
                                  {formatTokenSymbol(token)}, `x` is the amount
                                  of {formatTokenSymbol(token)} being cashed
                                  out.
                                </div>
                              </li>
                            </ul>
