 ...
 */
export function graphql(
  source: "query LoansByAccount($owner: String!) {\n  loans(where: {owner: $owner}) {\n    items {\n      borrowAmount\n      collateral\n      prepaidDuration\n      projectId\n      terminal\n      token\n      chainId\n      createdAt\n      id\n    }\n  }\n}\n\nquery LoansDetailsByAccount($owner: String!, $projectId: Int!) {\n  loans(where: {owner: $owner, projectId: $projectId}) {\n    items {\n      borrowAmount\n      collateral\n      prepaidDuration\n      createdAt\n      projectId\n      terminal\n      token\n      chainId\n      id\n    }\n  }\n}",
 ...
 */
export function graphql(
  source: "query HasPermission($account: String!, $chainId: Float!, $projectId: Float!, $operator: String!) {\n  permissionHolder(\n    account: $account\n    chainId: $chainId\n    projectId: $projectId\n    operator: $operator\n  ) {\n    permissions\n  }\n}",
): (typeof documents)["query HasPermission($account: String!, $chainId: Float!, $projectId: Float!, $operator: String!) {\n  permissionHolder(\n    account: $account\n    chainId: $chainId\n    projectId: $projectId\n    operator: $operator\n  ) {\n    permissions\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "query Project($projectId: Float!, $chainId: Float!) {\n  project(projectId: $projectId, chainId: $chainId) {\n    projectId\n    metadataUri\n    handle\n    createdAt\n    suckerGroupId\n    logoUri\n    name\n  }\n}\n\nquery Projects($where: projectFilter) {\n  projects(where: $where) {\n    items {\n      projectId\n      metadataUri\n      handle\n      createdAt\n      suckerGroupId\n      participants {\n        totalCount\n      }\n    }\n  }\n}\n\nquery ProjectAccountingContext($chainId: Float!, $projectId: Float!) {\n  project(chainId: $chainId, projectId: $projectId) {\n    token\n    decimals\n    currency\n  }\n}",
