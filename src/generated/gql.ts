...
const documents = {
    ...
    "query StoreAutoMintAmountEvents($where: StoreAutoMintAmountEvent_filter, $orderBy: StoreAutoMintAmountEvent_orderBy, $orderDirection: OrderDirection, $first: Int, $skip: Int) {\n  storeAutoMintAmountEvents(\n    where: $where\n    orderBy: $orderBy\n    orderDirection: $orderDirection\n    first: $first\n    skip: $skip\n  ) {\n    id\n    revnetId\n    beneficiary\n    count\n    stageId\n    caller\n  }\n}": types.StoreAutoMintAmountEventsDocument,
};
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query StoreAutoMintAmountEvents($where: StoreAutoMintAmountEvent_filter, $orderBy: StoreAutoMintAmountEvent_orderBy, $orderDirection: OrderDirection, $first: Int, $skip: Int) {\n  storeAutoMintAmountEvents(\n    where: $where\n    orderBy: $orderBy\n    orderDirection: $orderDirection\n    first: $first\n    skip: $skip\n  ) {\n    id\n    revnetId\n    beneficiary\n    count\n    stageId\n    caller\n  }\n}"): (typeof documents)["query StoreAutoMintAmountEvents($where: StoreAutoMintAmountEvent_filter, $orderBy: StoreAutoMintAmountEvent_orderBy, $orderDirection: OrderDirection, $first: Int, $skip: Int) {\n  storeAutoMintAmountEvents(\n    where: $where\n    orderBy: $orderBy\n    orderDirection: $orderDirection\n    first: $first\n    skip: $skip\n  ) {\n    id\n    revnetId\n    beneficiary\n    count\n    stageId\n    caller\n  }\n}"];
