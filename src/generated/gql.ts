...
type Documents = {
  ...
  "query HasPermission($account: String!, $chainId: Float!, $projectId: Float!, $operator: String!, $version: Float!) {\n  permissionHolder(\n    account: $account\n    chainId: $chainId\n    projectId: $projectId\n    operator: $operator\n    version: $version\n  ) {\n    permissions\n  }\n}": typeof types.HasPermissionDocument;
  ...
  "query ProjectOperator($chainId: Int!, $projectId: Int!, $version: Int!) {\n  permissionHolders(\n    where: {chainId: $chainId, projectId: $projectId, version: $version, isRevnetOperator: true}\n    limit: 1\n  ) {\n    items {\n      operator\n    }\n  }\n}": typeof types.ProjectOperatorDocument;
  "query ProjectWithPermissions($projectId: Float!, $chainId: Float!, $version: Float!) {\n  project(projectId: $projectId, chainId: $chainId, version: $version) {\n    projectId\n    chainId\n    version\n    owner\n    permissionHolders {\n      items {\n        account\n        operator\n        permissions\n      }\n    }\n  }\n}": typeof types.ProjectWithPermissionsDocument;
...
const documents: Documents = {
  ...
  "query ProjectOperator($chainId: Int!, $projectId: Int!, $version: Int!) {\n  permissionHolders(\n    where: {chainId: $chainId, projectId: $projectId, version: $version, isRevnetOperator: true}\n    limit: 1\n  ) {\n    items {\n      operator\n    }\n  }\n}":
    types.ProjectOperatorDocument,
  "query ProjectWithPermissions($projectId: Float!, $chainId: Float!, $version: Float!) {\n  project(projectId: $projectId, chainId: $chainId, version: $version) {\n    projectId\n    chainId\n    version\n    owner\n    permissionHolders {\n      items {\n        account\n        operator\n        permissions\n      }\n    }\n  }\n}":
    types.ProjectWithPermissionsDocument,
  "query StoreAutoIssuanceAmountEvents($where: storeAutoIssuanceAmountEventFilter, $orderBy: String, $orderDirection: String) {\n  storeAutoIssuanceAmountEvents(\n    where: $where\n    orderBy: $orderBy\n    orderDirection: $orderDirection\n  ) {\n    items {\n      id\n      projectId\n      beneficiary\n      count\n      stageId\n      caller\n    }\n  }\n}":
 ...
 */
export function graphql(
  source: "query LoansByAccount($owner: String!, $version: Int!) {\n  loans(where: {owner: $owner, version: $version}) {\n    items {\n      borrowAmount\n      collateral\n      prepaidDuration\n      projectId\n      terminal\n      token\n      chainId\n      createdAt\n      id\n      project {\n        version\n      }\n    }\n  }\n}\n\nquery LoansDetailsByAccount($owner: String!, $projectId: Int!, $version: Int!) {\n  loans(where: {owner: $owner, projectId: $projectId, version: $version}) {\n    items {\n      borrowAmount\n      collateral\n      prepaidDuration\n      createdAt\n      projectId\n      terminal\n      token\n      chainId\n      id\n      project {\n        version\n      }\n    }\n  }\n}",
): (typeof documents)["query LoansByAccount($owner: String!, $version: Int!) {\n  loans(where: {owner: $owner, version: $version}) {\n    items {\n      borrowAmount\n      collateral\n      prepaidDuration\n      projectId\n      terminal\n      token\n      chainId\n      createdAt\n      id\n      project {\n        version\n      }\n    }\n  }\n}\n\nquery LoansDetailsByAccount($owner: String!, $projectId: Int!, $version: Int!) {\n  loans(where: {owner: $owner, projectId: $projectId, version: $version}) {\n    items {\n      borrowAmount\n      collateral\n      prepaidDuration\n      createdAt\n      projectId\n      terminal\n      token\n      chainId\n      id\n      project {\n        version\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "query Participants($where: participantFilter, $orderBy: String, $orderDirection: String, $limit: Int) {\n  participants(\n    where: $where\n    orderBy: $orderBy\n    orderDirection: $orderDirection\n    limit: $limit\n  ) {\n    totalCount\n    items {\n      chainId\n      address\n      volume\n      lastPaidTimestamp\n      balance\n      erc20Balance\n      creditBalance\n    }\n  }\n}",
): (typeof documents)["query Participants($where: participantFilter, $orderBy: String, $orderDirection: String, $limit: Int) {\n  participants(\n    where: $where\n    orderBy: $orderBy\n    orderDirection: $orderDirection\n    limit: $limit\n  ) {\n    totalCount\n    items {\n      chainId\n      address\n      volume\n      lastPaidTimestamp\n      balance\n      erc20Balance\n      creditBalance\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "query HasPermission($account: String!, $chainId: Float!, $projectId: Float!, $operator: String!, $version: Float!) {\n  permissionHolder(\n    account: $account\n    chainId: $chainId\n    projectId: $projectId\n    operator: $operator\n    version: $version\n  ) {\n    permissions\n  }\n}",
): (typeof documents)["query HasPermission($account: String!, $chainId: Float!, $projectId: Float!, $operator: String!, $version: Float!) {\n  permissionHolder(\n    account: $account\n    chainId: $chainId\n    projectId: $projectId\n    operator: $operator\n    version: $version\n  ) {\n    permissions\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "query Project($projectId: Float!, $chainId: Float!, $version: Float!) {\n  project(projectId: $projectId, chainId: $chainId, version: $version) {\n    projectId\n    metadataUri\n    handle\n    createdAt\n    suckerGroupId\n    logoUri\n    name\n    version\n  }\n}\n\nquery Projects($where: projectFilter) {\n  projects(where: $where) {\n    items {\n      projectId\n      metadataUri\n      handle\n      createdAt\n      suckerGroupId\n      participants {\n        totalCount\n      }\n      version\n    }\n  }\n}\n\nquery ProjectAccountingContext($chainId: Float!, $projectId: Float!, $version: Float!) {\n  project(chainId: $chainId, projectId: $projectId, version: $version) {\n    token\n    decimals\n    currency\n  }\n}",
): (typeof documents)["query Project($projectId: Float!, $chainId: Float!, $version: Float!) {\n  project(projectId: $projectId, chainId: $chainId, version: $version) {\n    projectId\n    metadataUri\n    handle\n    createdAt\n    suckerGroupId\n    logoUri\n    name\n    version\n  }\n}\n\nquery Projects($where: projectFilter) {\n  projects(where: $where) {\n    items {\n      projectId\n      metadataUri\n      handle\n      createdAt\n      suckerGroupId\n      participants {\n        totalCount\n      }\n      version\n    }\n  }\n}\n\nquery ProjectAccountingContext($chainId: Float!, $projectId: Float!, $version: Float!) {\n  project(chainId: $chainId, projectId: $projectId, version: $version) {\n    token\n    decimals\n    currency\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "query ProjectCreateEvent($where: projectCreateEventFilter) {\n  projectCreateEvents(where: $where, limit: 1) {\n    items {\n      txHash\n      timestamp\n    }\n  }\n}",
): (typeof documents)["query ProjectCreateEvent($where: projectCreateEventFilter) {\n  projectCreateEvents(where: $where, limit: 1) {\n    items {\n      txHash\n      timestamp\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "query ProjectOperator($chainId: Int!, $projectId: Int!, $version: Int!) {\n  permissionHolders(\n    where: {chainId: $chainId, projectId: $projectId, version: $version, isRevnetOperator: true}\n    limit: 1\n  ) {\n    items {\n      operator\n    }\n  }\n}",
): (typeof documents)["query ProjectOperator($chainId: Int!, $projectId: Int!, $version: Int!) {\n  permissionHolders(\n    where: {chainId: $chainId, projectId: $projectId, version: $version, isRevnetOperator: true}\n    limit: 1\n  ) {\n    items {\n      operator\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "query ProjectWithPermissions($projectId: Float!, $chainId: Float!, $version: Float!) {\n  project(projectId: $projectId, chainId: $chainId, version: $version) {\n    projectId\n    chainId\n    version\n    owner\n    permissionHolders {\n      items {\n        account\n        operator\n        permissions\n      }\n    }\n  }\n}",
): (typeof documents)["query ProjectWithPermissions($projectId: Float!, $chainId: Float!, $version: Float!) {\n  project(projectId: $projectId, chainId: $chainId, version: $version) {\n    projectId\n    chainId\n    version\n    owner\n    permissionHolders {\n      items {\n        account\n        operator\n        permissions\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "query StoreAutoIssuanceAmountEvents($where: storeAutoIssuanceAmountEventFilter, $orderBy: String, $orderDirection: String) {\n  storeAutoIssuanceAmountEvents(\n    where: $where\n    orderBy: $orderBy\n    orderDirection: $orderDirection\n  ) {\n    items {\n      id\n      projectId\n      beneficiary\n      count\n      stageId\n      caller\n    }\n  }\n}",
 ...
 */
export function graphql(
  source: "query AutoIssueEvents($where: autoIssueEventFilter, $orderBy: String, $orderDirection: String) {\n  autoIssueEvents(\n    where: $where\n    orderBy: $orderBy\n    orderDirection: $orderDirection\n  ) {\n    items {\n      id\n      projectId\n      stageId\n      beneficiary\n      count\n      caller\n    }\n  }\n}",
): (typeof documents)["query AutoIssueEvents($where: autoIssueEventFilter, $orderBy: String, $orderDirection: String) {\n  autoIssueEvents(\n    where: $where\n    orderBy: $orderBy\n    orderDirection: $orderDirection\n  ) {\n    items {\n      id\n      projectId\n      stageId\n      beneficiary\n      count\n      caller\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "query SuckerGroup($id: String!) {\n  suckerGroup(id: $id) {\n    id\n    tokenSupply\n    projects {\n      items {\n        balance\n        chainId\n        currency\n        decimals\n        projectId\n        token\n        tokenSupply\n        tokenSymbol\n        version\n        suckerGroupId\n      }\n    }\n  }\n}",
