...
export type ProjectWithPermissionsQuery = { project: { projectId: number, metadataUri: string | null, handle: string | null, createdAt: number, suckerGroupId: string, deployer: string, permissionHolders: { items: Array<{ permissions: Array<number> | null, account: string, chainId: number, operator: string }> } | null } | null };
