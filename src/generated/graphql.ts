...
export type LoansDetailsByAccountQuery = { loans: { items: Array<{ borrowAmount: any, collateral: any, prepaidDuration: number, createdAt: number, projectId: number, terminal: string, token: string, chainId: number }> } };
