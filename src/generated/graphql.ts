...
export type TopSuckerGroupsQuery = { suckerGroups: { items: Array<{ balance: any, version: number, projects: { items: Array<{ decimals: number | null, currency: any | null, chainId: number, name: string | null, projectTagline: string | null, tokenSymbol: string | null, logoUri: string | null, projectId: number }> } | null }> } };
