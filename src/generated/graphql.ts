...
export type CashOutTaxSnapshotsQuery = { cashOutTaxSnapshots: { items: Array<{ cashOutTax: number, start: any, duration: any, rulesetId: any, suckerGroupId: string, version: number }> } };
...
export type SuckerGroupMomentsQuery = { suckerGroupMoments: { items: Array<{ timestamp: number, balance: any, tokenSupply: any, suckerGroupId: string, version: number }> } };
