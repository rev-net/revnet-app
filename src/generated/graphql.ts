...
export type ProjectQuery = { project: { projectId: number, metadataUri: string | null, handle: string | null, createdAt: number, suckerGroupId: string, logoUri: string | null, name: string | null } | null };
...
export type SuckerGroupQuery = { suckerGroup: { id: string, tokenSupply: any, projects: { items: Array<{ chainId: number, projectId: number, token: string | null, currency: any | null, decimals: number | null }> } | null } | null };
