...
export type ProjectQuery = { project: { projectId: number, metadataUri: string | null, handle: string | null, createdAt: number, suckerGroupId: string | null } | null };
...
export type ProjectsQuery = { projects: { items: Array<{ projectId: number, metadataUri: string | null, handle: string | null, createdAt: number, suckerGroupId: string | null, participants: { totalCount: number } | null }> } };
