...
export type SuckerGroupQuery = { suckerGroup: { id: string, tokenSupply: any, projects: { items: Array<{ chainId: number, projectId: number, token: string | null, currency: any | null, decimals: number | null, version: number }> } | null } | null };
