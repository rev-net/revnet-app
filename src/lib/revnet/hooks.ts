...
export function useBasicRevnetDeployerRead<
  ...
  TSelectData = ReadContractResult<typeof basicRevnetDeployerABI, TFunctionName>
>(
  config: Omit<
    UseContractReadConfig<
  ...
  return useContractRead({
    ...
    ...config,
  } as UseContractReadConfig<typeof basicRevnetDeployerABI, TFunctionName, TSelectData>);
}
...
>(
  ...
  return usePrepareContractWrite({
    ...
    address: basicRevnetDeployerAddress[5],
    ...config,
  } as UsePrepareContractWriteConfig<typeof basicRevnetDeployerABI, TFunctionName>);
}
...
export function usePrepareBasicRevnetDeployerDeployRevnetFor(
  ...
  return usePrepareContractWrite({
    ...
    functionName: "deployRevnetFor",
    ...config,
  } as UsePrepareContractWriteConfig<typeof basicRevnetDeployerABI, "deployRevnetFor">);
}
...
export function usePrepareBasicRevnetDeployerReplaceBoostOperatorOf(
  ...
  return usePrepareContractWrite({
    ...
    functionName: "replaceBoostOperatorOf",
    ...config,
  } as UsePrepareContractWriteConfig<typeof basicRevnetDeployerABI, "replaceBoostOperatorOf">);
}
...
export function usePrepareBasicRevnetDeployerScheduleNextBoostOf(
  ...
  return usePrepareContractWrite({
    ...
    functionName: "scheduleNextBoostOf",
    ...config,
  } as UsePrepareContractWriteConfig<typeof basicRevnetDeployerABI, "scheduleNextBoostOf">);
}
